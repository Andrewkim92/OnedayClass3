...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <p class="mb-5"><img src="/resources/images/img_1.jpg" alt="/resources/image" class="img-fluid rounded"></p>
          </div>
          <div class="col-lg-5 ml-auto">
            ...
            <div class="trainers-small mb-5 d-flex">
              <div><img src="/resources/images/person_1.jpg" alt="/resources/image" class="rounded-circle trainer first" data-toggle="tooltip" data-placement="top" title="Craig David"></div>
              <div><img src="/resources/images/person_2.jpg" alt="/resources/image" class="rounded-circle trainer" data-toggle="tooltip" data-placement="top" title="James Creen"></div>
              <div><img src="/resources/images/person_3.jpg" alt="/resources/image" class="rounded-circle trainer" data-toggle="tooltip" data-placement="top" title="Ben Smith"></div>
            </div>
            <p><a href="#" class="btn btn-outline-primary py-2 px-4">Join This Program</a></p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2">
            <p class="mb-5"><img src="/resources/images/img_2.jpg" alt="/resources/image" class="img-fluid rounded"></p>
          </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <p class="mb-5"><img src="/resources/images/img_3.jpg" alt="/resources/image" class="img-fluid rounded"></p>
          </div>
          <div class="col-lg-5 ml-auto">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 order-md-2">
            <p class="mb-5"><img src="/resources/images/img_4.jpg" alt="/resources/image" class="img-fluid rounded"></p>
          </div>

...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
    ...
    <div class="site-section bg-/resources/image" style="background-image: url('/resources/images/bg_2.jpg'); background-attachment: fixed;">
      <div class="container">
        
        <div class="row">
          <div class="col-md-6 text-center mb-5">
            <div class="p-3">
              <img src="/resources/images/person_1.jpg" alt="/resources/image" class="img-fluid rounded-circle w-25 mb-4">
          ...
          <div class="col-md-6 text-center mb-5">
            <div class="p-3">
              <img src="/resources/images/person_2.jpg" alt="/resources/image" class="img-fluid rounded-circle w-25 mb-4">
          ...
          <div class="col-md-6 text-center mb-5">
            <div class="p-3">
              <img src="/resources/images/person_3.jpg" alt="/resources/image" class="img-fluid rounded-circle w-25 mb-4">
              <h2 class="h5 mb-4 text-white">Joshua Creen</h2>
              <p class="text-white mb-5 lead">&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Expedita et aliquam fuga dicta amet ad laborum error recusandae, voluptatibus quam minima sed, saepe odio voluptatem. Sed unde hic, vitae fugiat.&rdquo;</p>
              <p><a href="#" class="btn btn-primary text-white">Make Me Your Trainer</a></p>
            </div>
          </div>
          ...
          <div class="col-md-6 text-center mb-5">
            <div class="p-3">
              <img src="/resources/images/person_4.jpg" alt="/resources/image" class="img-fluid rounded-circle w-25 mb-4">
              <h2 class="h5 mb-4 text-white">Shane Holmes</h2>
              <p class="text-white mb-5 lead">&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Expedita et aliquam fuga dicta amet ad laborum error recusandae, voluptatibus quam minima sed, saepe odio voluptatem. Sed unde hic, vitae fugiat.&rdquo;</p>
              <p><a href="#" class="btn btn-primary text-white">Make Me Your Trainer</a></p>
            </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-12">
            <h2 class="site-section-heading text-center">Crossfit Exercises</h2>
          </div>
        </div>
        <div class="row">
      ...
      <div class="container">
        ...
        <div class="nonloop-block-14 owl-carousel">
          ...
          <div class="p-5">
            <div class="d-flex block-testimony">
              <div class="person mr-3">
                <img src="/resources/images/person_1.jpg" alt="/resources/image" class="img-fluid rounded-circle">
              </div>
              <div>
          ...
          <div class="p-5">
            <div class="d-flex block-testimony">
              <div class="person mr-3">
                <img src="/resources/images/person_2.jpg" alt="/resources/image" class="img-fluid rounded-circle">
              </div>
              <div>
          ...
          <div class="p-5">
            <div class="d-flex block-testimony">
              <div class="person mr-3">
                <img src="/resources/images/person_3.jpg" alt="/resources/image" class="img-fluid rounded-circle">
              </div>
              <div>
          ...
          <div class="p-5">
            <div class="d-flex block-testimony">
              <div class="person mr-3">
                <img src="/resources/images/person_4.jpg" alt="/resources/image" class="img-fluid rounded-circle">
              </div>
              <div>

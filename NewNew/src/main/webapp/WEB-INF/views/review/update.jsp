...
<h1>
    ...
    <form action="/review/update" method="POST">
        ...
        <div class="createForm">
            <label>별점</label>
            <input type="number" name="reviewRate" class="createForm" min="1" max="10" value = ${readOne.reviewRate}>
        </div>
        <div class="createForm">
            <label>리뷰내용</label>
            <textarea rows="4" cols="15" wrap="hard" name="reviewComment" class="createForm" placeholder = "리뷰 내용">${readOne.reviewComment}</textarea>
        </div>

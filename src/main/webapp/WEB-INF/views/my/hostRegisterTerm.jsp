...
<div id="hostRegisterArea"
	style="width:100%; height:1200px; margin: 100px 0px 100px 0px; text-align: center;">
	...
	<div id="TermArea">
		...
		<div id="personInfo" style="display: none;">
			<textarea rows="10" cols="70" readonly="readonly">*이용약관, 개인정보 취급방침을 꼭 확인해주세요. (자세한 사항은 이용약관을 확인해주시기 바랍니다.)</textarea>
		</div>
		<br>
		<div
		...
		<br>
		<a href="/my/hostRegister"><button value="동의하기">동의하기</button></a>
	</div>
